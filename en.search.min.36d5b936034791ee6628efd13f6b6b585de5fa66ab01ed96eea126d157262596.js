...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.46a3b315749c6792f8f1795a10ef49ecd25685410c92264ea8dc80894a276ffa.js',function(){input.required=false;search();});}
