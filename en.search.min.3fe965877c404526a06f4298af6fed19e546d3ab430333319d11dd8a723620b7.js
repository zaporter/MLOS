...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.abb3b513806da546095d1cf8482d97ae315272764fc71f914d8976b4dbaeea54.js',function(){input.required=false;search();});}
