...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.1adc5a46be1b757cd0e9728025f7824b700534b12802dc6463d70bc8a77f696d.js',function(){input.required=false;search();});}
