...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.e9e00a9606ac5eb3aced6464a83d5f697d1bc6162210f41f0e3d7f889091bab3.js',function(){input.required=false;search();});}
