...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.4f944e4d9e9a94bdb6cadcbac9b04cbdbed687fda42ed88bb6b54666c8e9776d.js',function(){input.required=false;search();});}
