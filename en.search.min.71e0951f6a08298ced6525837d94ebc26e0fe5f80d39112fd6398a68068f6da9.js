...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.cc179136622a0690916c8550d92631375cf4d1ad7131d62f903f33ac57afe743.js',function(){input.required=false;search();});}
