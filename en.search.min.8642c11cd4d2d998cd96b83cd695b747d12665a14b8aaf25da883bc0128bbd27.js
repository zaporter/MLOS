...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.6a3356c5730f599021c646d97bb90645ff308601a053ad626cc4e1ad1870aff2.js',function(){input.required=false;search();});}
