...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.5aac3b5ccbc5349f5a6d4d8a6c00f227c44ec6d12fba8b71083a704d2bd83dde.js',function(){input.required=false;search();});}
