...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.cd0aac5d7a5b1eb9513235f28fc84813a6cc126a7fde1e16f36b795eaf6bebd1.js',function(){input.required=false;search();});}
