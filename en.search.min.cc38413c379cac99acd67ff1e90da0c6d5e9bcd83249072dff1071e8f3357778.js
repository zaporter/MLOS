...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.9cf7206f78faf45fbef54e8b53a4283b44264a772a893a2e448b822acc3be856.js',function(){input.required=false;search();});}
