...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.2295a1d20605564adad58eb8f10bc3d2c5cc3fc36b48e913384e83ca022db11d.js',function(){input.required=false;search();});}
