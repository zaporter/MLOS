...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.6112d700180fa2299cd8c633bde404a06ef7e02a48c619bf337ff15c33b453de.js',function(){input.required=false;search();});}
