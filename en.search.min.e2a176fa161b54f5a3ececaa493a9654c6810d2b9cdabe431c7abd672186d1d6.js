...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.9d1bff42d85b06521830eeca8c8b3278709054d0cbf46f5864e0872ce01afef4.js',function(){input.required=false;search();});}
