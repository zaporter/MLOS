...
function init(){input.removeEventListener('focus',init);input.required=true;loadScript('/MLOS/flexsearch.min.js');loadScript('/MLOS/en.search-data.min.74af601f3236f0fccdff1dab545c7647affcefb9f130546a283fc86d2b2d374c.js',function(){input.required=false;search();});}
